...
// PERSISTENCE
let lifetimeScore = parseInt(localStorage.getItem('societiesScore')) || 0;
let completedLessons = JSON.parse(localStorage.getItem('completedSocietiesLessons')) || [];
...
// STATIONS
const stations = [
    {file:"01_BlackHand.mp3", title:"The Black Hand"},
    {file:"02_Boxers.mp3", title:"The Boxers (Yihetuan)"},
    {file:"03_Camorra.mp3", title:"The Camorra"},
    {file:"04_Carbonari.mp3", title:"The Carbonari"},
    {file:"05_Freemasons.mp3", title:"The Freemasons"},
    {file:"06_Hashashin.mp3", title:"The Hashashin (Alamut)"},
    {file:"07_Illuminati.mp3", title:"The Illuminati"},
    {file:"08_KnightsHospitaller.mp3", title:"The Knights Hospitaller"},
    {file:"09_KnightsSaintLazarus.mp3", title:"Knights of St. Lazarus"},
    {file:"10_KnightsHolySepulchre.mp3", title:"Knights of the Holy Sepulchre"},
    {file:"11_KnightsTemplar.mp3", title:"The Knights Templar"},
    {file:"12_KuKluxKlan.mp3", title:"The Ku Klux Klan"},
    {file:"13_LivonianBrothers.mp3", title:"Livonian Brothers of the Sword"},
    {file:"14_Ninja.mp3", title:"The Ninja (Shinobi)"},
    {file:"15_OpusDei.mp3", title:"The Opus Dei"},
    {file:"16_OrderDragon.mp3", title:"The Order of the Dragon"},
    {file:"17_SicilianMafia.mp3", title:"Sicilian Mafia (Cosa Nostra)"},
    {file:"18_TeutonicKnights.mp3", title:"The Teutonic Knights"},
    {file:"19_Thuggee.mp3", title:"The Thuggee"},
    {file:"20_Triads.mp3", title:"The Triads"},
    {file:"21_Yakuza.mp3", title:"The Yakuza"}
];
...
function finishQuiz() {
    lifetimeScore += totalScore; localStorage.setItem('societiesScore', lifetimeScore);
    const fn = decodeURIComponent(audio.src.split('/').pop());
    if(!completedLessons.includes(fn)) {
        completedLessons.push(fn); localStorage.setItem('completedSocietiesLessons', JSON.stringify(completedLessons));
    }
